...
# Try to import flash attention interface.
# Newer environments often expose it under flash_attn.flash_attn_interface.
try:
    ...
    def forward(self, x: Tensor, pos=None) -> Tensor:
        ...
        if self.fused_attn:
            if FLASH_ATTN_AVAILABLE:
                ...
                # FA3 bindings may return a tuple, while FA2 bindings return a tensor.
