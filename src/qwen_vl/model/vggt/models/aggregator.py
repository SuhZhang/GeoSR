...
class Aggregator(nn.Module):
    ...
    def forward(self, images: torch.Tensor) -> Tuple[List[torch.Tensor], int]:
        ...
        # DeepSpeed ZeRO offload can leave buffers on CPU; align stats to input device/dtype.
        resnet_mean = self._resnet_mean.to(device=images.device, dtype=images.dtype)
        resnet_std = self._resnet_std.to(device=images.device, dtype=images.dtype)
